...
<p><em>Bamiyan’s fragments are still being cataloged. Support recovery at <a href="https://whc.unesco.org/" target="_blank">UNESCO</a>. And remember: The best “fuck you” to tyrants is outliving them.</em></p>
    ...
    image: "/photo_2025-06-26_16-46-31.jpg",
  },
   {
    id: 1,
    title:
    ...
    category: "knowledge",
    image: "/photo_2025-06-26_04-15-32.jpg",
  },
  {
    id: 2,
...
My hatred for her burns, brutally clear.
    ...
    category: "poem",
    image: "/ChatGPT Image Jun 23, 2025, 11_11_40 PM.png",
  },
  {
    id: 3,
...
`,
    ...
    category: ["knowledge", "history"],
    image: "/ChatGPT Image Jun 23, 2025, 05_12_53 PM.png",
  },
  {
    id: 4,
...
<p><strong>67. Serve</strong> = Look amazing ("That dress? She served.")</p>
...
const logoLinks = document.querySelectorAll(".logo, .footer-logo");

// Full post elements
const fullPostImage = document.getElementById("full-post-image");
const fullPostAuthorImg = document.getElementById("full-post-author-img");
const fullPostAuthor = document.getElementById("full-post-author");
...
function navigateToPage(pageId) {
  ...
  // If going to search page, focus input
...
// Logo navigation (header and footer)
...
function showFullPost(post) {
  ...
  fullPostAuthorImg.src = post.authorImg;
  fullPostAuthor.textContent = post.author;
  fullPostDate.textContent = `${post.date} • ${post.time}`;
  fullPostTitle.textContent = post.title;
  fullPostContent.innerHTML = post.content;

  navigateToPage("post-page");
}
...
function searchPosts(query) {
  ...
  results.forEach((post) => {
    ...
    resultCard.classList.add("post-card");
    resultCard.setAttribute("data-id", post.id);
...
// ===== Scroll Fix and Back Navigation =====

let fromPostView = false;
...
// Ensure nav menu items like About, Contact, Privacy scroll to top
navLinks.forEach(link => {
