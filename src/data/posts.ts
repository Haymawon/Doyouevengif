...
<div class="love">
  ...
  <div class="day">
    <div class="day-header">
      <span class="day-title">၁ ရက်</span>
      <span class="time">22:26 PM</span>
      <span class="date">4.12.2026</span>
    </div>

    <p class="diary-text">တီချယ်က တရားစခန်းဝင်သွားတော့ ဟေမဝန်လေးအထီးကျန်နေရပါတယ်။</p>
    <p class="diary-text">ညနေကလဲ အအေးဘူးလေးပေးတာ ခေါင်းခါပြလို့ ရှက်ရပါတယ်။</p>
    <p class="diary-text">ဒါမဲ့လဲ အတင်းပေးခဲ့တာဆိုတော့ ယူရမှာပဲလေ။</p>
    <p class="diary-text">မယူရင် ကိုင်ပေါက်မှာတကယ်။</p>
    <p class="diary-text">ဒီနေ့ soju သောက်ဖြစ်ပြန်ပါတယ်။</p>
    <p class="diary-text">တီချယ်သိရင် စိတ်ဆိုးမှာ။</p>
    <p class="diary-text">ခွင့်လွှတ်ပါ။</p>
  </div>

  <div class="day center">
    <div class="day-title">၂ ရက်</div>
    <div class="dots">။။။။</div>
  </div>

  <div class="day">
    <div class="day-header">
      <span class="day-title">၃ ရက်</span>
      <span class="time">22:10 PM</span>
      <span class="date">14.4.2026</span>
    </div>

    <p class="diary-text">ဒီနေ့ အရင်နေ့တွေထက်ပိုပြီး စကားပြောရပါတယ်။</p>
    <p class="diary-text">မနက်ဖြန်အကြတ်နေ့မို့ အကုသိုလ်တွေမလုပ်ဘဲ ကုသိုလ်တွေလုပ်ဖို့ကို ဆုံးမသွားပါသေးတယ်။</p>
  </div>

  <div class="day">
    <div class="day-header">
      <span class="day-title">၄ ရက်</span>
      <span class="time">23:50 PM</span>
      <span class="date">15.4.2026</span>
    </div>

    <p class="diary-text">ဒီနေ့လဲ အစောရီးအိပ်သွားပါပြီ။</p>
    <p class="diary-text">တရားစခန်းဝင်တာ ခြောက်ရက်ဆိုတော့ နောက်ထပ် 2 ရက်ပဲ ကျန်တော့တယ်။</p>
    <p class="diary-text">ညနေကလဲ သတိပေးသွားပါသေးတယ်။</p>
    <p class="diary-text">အမ ဘာသံ ညာသံတွေ မကြားချင်ဘူးနော် တဲ့။</p>
    <p class="diary-text">ကြားတာနဲ့ တန်းစကားမပြောဘူး တဲ့။</p>
    <p class="diary-text">ဆံပင်လဲ ညှပ်ရပါဦးမယ်။</p>
    <p class="diary-text">9 ရက် အချိန်ပေးထားတာ အခုထိ မညှပ်ရသေးဘူး။</p>
    <p class="diary-text">မနက်ဖြန်ကြရင်တော့ သူငယ်ချင်းတွေနဲ့ လျှောက်လည်မို့ စိတ်ကူးထားတယ်။</p>
    <p class="diary-text">လည်မယ်သာပြောတာ ဘယ်ကိုလည်ရမလဲ မသိဘူးရယ်။</p>
    <p class="diary-text">မဏ္ဍပ်တွေလဲ မသွားချင်ဘူး။</p>
    <p class="diary-text">လူအရမ်းများတယ်။ အသံတွေလဲ ဆူတယ်။ မနေတတ်ဘူး။</p>
    <p class="diary-text">ဒီတိုင်း ရေပက်ခံတာပဲ ကောင်းပါတယ်။</p>
    <p class="diary-text">မုန့်စားဘာညာပေါ့။</p>
  </div>

  <div class="day">
    <div class="day-header">
      <span class="day-title">၅ ရက်</span>
      <span class="time">1:44 AM</span>
      <span class="date">17.4.2026</span>
    </div>

    <p class="diary-text">ဘယ်မှလဲ မလည်ဖြစ်ပါဘူး။</p>
    <p class="diary-text">အပြင်ထွက်ရမှာ စိတ်မပါလို့။</p>
    <p class="diary-text">တီချယ်က ဒီနှစ် ပိတောက်ပန်း မပန်ရဘူးလို့ ပြောတယ်။</p>
    <p class="diary-text">နောက်နှစ်ပန်ပေါ့လို့ ပြောတာ နောက်နှစ်ကျပေးမှာလားတဲ့။</p>
    <p class="diary-text">သူများတွေပေးရင်တော့ မပေးတော့ဖို့ကို ဆုံးဖြတ်ထားပါတယ်။</p>
    <p class="diary-text">ဆံပင်ညှပ်ဖို့လဲ သတိပေးသွားပါသေးတယ်။</p>
  </div>

  <div class="note">
    <div class="day-header">
      <span class="day-title">နွေ</span>
      <span class="date">17.4.2026</span>
    </div>

    <p>နွေဦးမှာ ရွက်ဟောင်းကြွေ ရွက်သစ်ဖူးကြတယ်မဟုတ်လား။</p>
    <p>ကျနော်ဟာ ကြွေကျသွားတဲ့ရွက်ဟောင်းတွေပါ။</p>
    <p>ဘယ်တော့မှ အသစ်တစ်ဖန် ပွင့်ဖူးလာတော့မှာ မဟုတ်ပါ။</p>
  </div>

  <div class="day">
    <div class="day-header">
      <span class="day-title">၆ ရက်</span>
      <span class="time">2:54 AM</span>
      <span class="date">19.4.2026</span>
    </div>

    <p class="diary-text">၆ ရက်မြောက်နေ့ဟာ စိတ်ညစ်စရာတွေများခဲ့တဲ့အတွက် ရေးတာနောက်ကျနေပါတယ်။</p>
    <p class="diary-text">တီချယ်က တစ်ယောက်တည်းပဲ နေတော့မှာတဲ့။</p>
    <p class="diary-text">35 ကျော်ရင်လဲ ယောင်္ကျားမယူတော့ဘူး ပြောထားပြီးသားလေ။</p>
    <p class="diary-text">သူဘာဖြစ်ချင်နေတာလဲ နားမလည်တော့ပါဘူး။</p>
    <p class="diary-text">ကျနော့်ကို ခလေးဆိုပြီး အထင်သေးနေတာပါ။</p>
    <p class="diary-text">ကျနော့်အချစ်တွေကို မယုံတာပါ။</p>
  </div>
